...
try:
    ...
    try:
        ...
        from MEA_Analysis.IPNAnalysis.UnitMatch.reporting import UnitMatchReportConfig, generate_unitmatch_static_report_pack
    except ImportError:
        run_unitmatch_merge_with_recursion = None
        UnitMatchConfig = None
        UnitMatchReportConfig = None
        generate_unitmatch_static_report_pack = None


class MergeMixin:
    """Phase 2.5 (optional): unit merging via UnitMatch or auto_merge_units."""
